...
import koza.licensemanagementservice.dashboard.dto.response.QSoftwareStatsResponse;
...
import koza.licensemanagementservice.domain.software.dto.condition.SoftwareAdminSearchTarget;
...
public class SoftwareRepositoryImpl implements SoftwareRepositoryCustom {
    private final JPAQueryFactory queryFactory;

    @Override
    public Optional<AdminSoftwareDetailResponse> findBySoftwareId(Long softwareId) {
        return Optional.ofNullable(queryFactory
                .select(
                        new QAdminSoftwareDetailResponse(
                                software.id,
                                member.email,
                                member.nickname,
                                software.name,
    ...
    @Override
    public Page<AdminSoftwareSummaryResponse> searchSoftwareByCondition(SoftwareAdminSearchCondition condition, Pageable pageable) {
        List<AdminSoftwareSummaryResponse> content = queryFactory
                .select(
                        new QAdminSoftwareSummaryResponse(
                                software.id,
                                software.name,
                                softwareVersion.version,
                                member.email,
