...
import koza.licensemanagementservice.domain.audit.dto.response.QAdminAuditLogResponse;
import koza.licensemanagementservice.domain.audit.dto.response.QAdminRecentAuditResponse;
...
public class AdminAuditLogRepositoryImpl implements AdminAuditLogRepositoryCustom {
    ...
    @Override
    public List<AdminRecentAuditResponse> findRecent(int limit) {
        return queryFactory
                .select(new QAdminRecentAuditResponse(
                        adminAuditLog.id,
    ...
    @Override
    public Page<AdminAuditLogResponse> search(AuditSearchCondition condition, Pageable pageable) {
        ...
        List<AdminAuditLogResponse> content = queryFactory
                .select(new QAdminAuditLogResponse(
                        adminAuditLog.id,
                        adminAuditLog.eventCategory,
