...
@AllArgsConstructor
@Builder
public class LicenseAdminExtendResponse {
    private String name;
    ...
    public static LicenseAdminExtendResponse of(License license, int extendDays) {
        long remainingMs = calcRemainingMs(license.getExpiredAt());

        return LicenseAdminExtendResponse.builder()
